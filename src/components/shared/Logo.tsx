...
const Logo = ({
  ...
  return (
    ...
    >
      ...
      >
        <g clipPath='url(#clip0_51109_5452)'>
          <mask
            id='mask0_51109_5452'
          ...
          <g mask='url(#mask0_51109_5452)'>
            <path
              ...
              fill={logoColor === 'red' ? '#C12116' : '#ffffff'}
            />
          </g>
        </g>
        <defs>
          <clipPath id='clip0_51109_5452'>
      ...
      <span
        className={cn(
          ...
          textColor === 'dark' ? 'text-neutral-950' : 'text-white',
          stayVisibleText ? '' : 'hidden'
        )}
      >
        Food
      </span>
